...
public class CascadeTest {
    ...
    void test1() {
        ...
        // user entity 만 저장하면 되지 않나?
        // 영속성 전이에 persist 옵션을 지원하는데
        // 이걸 통해 save 를 줄일 수 있다.
    }
    @Test
    ...
    void test2() {
        ...
        userRepository.save(user);
        //user 만,  cascade 를 통해서 한번에 저장됨.
    }
    @Test
    @Transactional // 지연로딩이니까 필요
    ...
    void test3() {
        ...
        // cascade remove 옵션을 지원해서 이 문구를 안써도 쓸 수 있음.
